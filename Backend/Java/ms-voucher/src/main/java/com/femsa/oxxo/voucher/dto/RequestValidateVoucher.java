/*
 * @(#)RequestValidateVoucher.java 1.0.0 12/05/25
 * 
...
/**
 * Clase que implementa el request del endpoint validate 
 *
 * @author GTIM
 ...
 */
@Data
public class RequestValidateVoucher {
	...
	@NotNull(message = "El elemento coupon es obligatorio")
	...
	@NotNull(message = "El elemento transactionId es obligatorio")
